...
# constant values
'''
N_Initial_Frames: Number of frames to calculate intial EAR (recommended > 20)
Holding_Frames: Number of frames to hold when detect Drowsiness State (recommended > 20 according to FPS) 
...
job:    save the eyes coordinates in two list (left_coord[] & right coord[])
output: left_coord[] & right coord[]
"""
